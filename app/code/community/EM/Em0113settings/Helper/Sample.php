<?php
class EM_Em0113settings_Helper_Sample extends Mage_Core_Helper_Abstract
{
	protected $_themeSlug  = 'default/em0113';
	...
	protected $_megaMenuModel = 'em0113settings/megamenupro';
	protected $_themeFrameworkAreaModel = 'themeframework/area';
	
	public function importSampleData($installer){
		$installer->startSetup();
		$pathFile = Mage::getBaseDir('var').DS.'install_em0113.txt';
		if(file_exists($pathFile)){
			echo 'Installing EM0113 theme, please come back in some minutes ...';
			exit;
		}
		file_put_contents($pathFile,'Installing EM0113 theme');
