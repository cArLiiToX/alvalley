<?php
class EM_Em0113settings_Adminhtml_Em0113settings_ThemeController extends Mage_Adminhtml_Controller_Action
{
	protected $_prefixBlock = 'em0113_';
	protected $_prefixPage = 'em0113_';
	protected $_packageTheme = 'default/em0113';
