<?php
class EM_Em0113settings_Adminhtml_Em0113settings_LinkController extends Mage_Adminhtml_Controller_Action
{
	...
	public function userguideAction() {
		$this->getResponse()->setRedirect('http://www.emthemes.com/documentation/em0113-userguide/');
	}
